...
export default function Homelies() {
  ...
  const [selected, setSelected] = useState<typeof HOMELIES[0] | null>(null);
            ...
            <div className="mb-10 rounded-2xl overflow-hidden border border-gray-100 shadow-sm">
              <div className="grid grid-cols-1 md:grid-cols-2">
                ...
                <div className="p-8 bg-blue-50">
                  <div style={{ fontFamily: "Montserrat, sans-serif", fontSize: "0.7rem", color: "#9ca3af" }} className="mb-2">{HOMELIES[0].date}</div>
              ...
              <div key={h.id}
                ...
                <div className="flex gap-0">
                  ...
                  <div className="p-5 flex-1">
                    <div style={{ fontFamily: "Montserrat, sans-serif", fontSize: "0.68rem", color: "#9ca3af" }}>{h.date}</div>
          ...
          <div className="bg-white rounded-2xl max-w-lg w-full shadow-2xl overflow-hidden" onClick={e => e.stopPropagation()}>
            ...
            <div className="p-6">
              <div className="flex flex-wrap gap-4 mb-5 text-sm">
                {[["📅", selected.date], ["👤", selected.priest], ["📖", selected.readings], ["⏱", selected.duration]].map(([icon, val]) => (
